...
const PriceListAdjustment: React.FC = () => {
  ...
  const deactivateColumns = [
    { title: '生效', dataIndex: 'active', key: 'active', width: 60 },
    {
      title: '停用项目',
      children: [
        { title: '收费项目编码', dataIndex: ['detail', 'priceList', 0, 'priceCode'], key: 'code', width: 120 },
        { title: '项目名称', dataIndex: ['detail', 'itemName'], key: 'itemName', width: 150 },
        { title: '单位', dataIndex: ['detail', 'unit'], key: 'unit', width: 60 },
        { title: '项目代码', dataIndex: ['detail', 'itemCode'], key: 'itemCode', width: 100 },
        { title: '项目分类', dataIndex: ['detail', 'itemClassName'], key: 'itemClassName', width: 100 },
      ],
    },
    {
      title: '替换项目',
      children: [
        { title: '收费项目编码', dataIndex: ['replaceItem', 'priceList', 0, 'priceCode'], key: 'repCode', width: 120 },
        { title: '项目名称', dataIndex: ['replaceItem', 'itemName'], key: 'repName', width: 150 },
        { title: '单位', dataIndex: ['replaceItem', 'unit'], key: 'repUnit', width: 60 },
        { title: '项目代码', dataIndex: ['replaceItem', 'itemCode'], key: 'repItemCode', width: 100 },
      ],
    },
