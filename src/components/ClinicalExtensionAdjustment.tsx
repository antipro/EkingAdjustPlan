...
const ClinicalExtensionAdjustment: React.FC = () => {
  ...
  return (
    <div style={{ display: 'flex', flex: 1 }}>
          ...
          {activeTab === '2' ? (
            <>
              <Row gutter={16} align="middle">
                ...
                <Col span={6}>
                  <div style={{ display: 'flex', alignItems: 'center' }}>
                    <span style={{ whiteSpace: 'nowrap', marginRight: 8 }}>临床拓展项目:</span>
                    <Input 
      ...
      <ClinicalItemModal 
        ...
        onOk={(values) => {
          console.log('New Clinical Extension Item:', values);
...
export default ClinicalExtensionAdjustment;
